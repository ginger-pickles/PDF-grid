...
Add the ability to switch between PDFs residing in the direcotry from which index.html is served.

Add support for drag-and-drop loading of local PDF.

Add support for loading a PDF from the web; using a URL input form, or as an argument when the page is loaded.
